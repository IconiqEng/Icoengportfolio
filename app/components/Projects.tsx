...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A full-featured real estate CRM with AI-powered voice receptionist for automated lead capture and client management.',
    longDescription: 'Built and deployed EstateFlow CRM — an end-to-end real estate customer relationship management platform integrated with an AI voice receptionist that handles incoming calls, qualifies leads, books appointments, and keeps agents informed via WhatsApp and email notifications.',
    category: 'Real Estate CRM',
    tags: ['CRM', 'AI Voice Receptionist', 'Lead Qualification', 'Call Automation'],
    gradient: 'from-amber-500 to-orange-500',
    features: [
      'Full real estate CRM',
      'AI voice receptionist setup',
      'Automatic incoming call handling',
    ...
    liveUrl: 'https://real-estate-crm-six-rho.vercel.app/',
    previewImage: '/EstateFlow CRM.png',
  },
  {
